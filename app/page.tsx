  ...
  return (
    <div className={`blackCard p-4 ${isPaid ? "ring-2 ring-green-400/35 shadow-[0_0_32px_rgba(34,197,94,0.16)]" : ""}`}>
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        ...
        <button className="darkButton" onClick={() => setPreview(!preview)}><Eye size={16} /> {preview ? "Hide" : "Designer"}</button>
        ...
        <button className="darkButton" onClick={() => { setPreview(true); setTimeout(() => window.print(), 250); }}><Printer size={16} /> PDF</button>
