                ...
                {filteredEmployees.map((employee) => {
                  ...
                  return (
                    <EmployeeCard
                      ...
                      onMarkWeekPaid={markEmployeeWeekPaid}
...
function EmployeeCard({
  ...
  onMarkWeekPaid: (employeeId: string) => void;
  weekStart: string;
}) {
        ...
        <div className="mt-4 space-y-3 border-t border-zinc-800 pt-4">
          {editing ? (
            ...
            <>
              ...
              <button
                type="button"
                onClick={() => onMarkWeekPaid(employee.id)}
                className="goldButton w-full"
              >
                <ShieldCheck size={18} /> Mark This Employee Paid for the Week
              </button>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/30 p-3">
                ...
                >
                  <span className="text-sm font-black text-green-400">Weekly Work History</span>
                  <span className="rounded-xl border border-white/10 bg-black/30 px-3 py-1 text-xs font-black text-zinc-400">
                ...
                {showHistory && (
                  <>
                    <div className="mt-3 rounded-2xl border border-green-400/20 bg-green-500/10 p-3">
                      <p className="text-xs font-black uppercase tracking-wider text-green-400">This Week</p>
                      <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
                        <div className="rounded-xl border border-white/10 bg-black/25 p-2">
                          <p className="text-zinc-500">Jobs</p>
                          <p className="text-base font-black text-zinc-100">{totals?.jobs.length || 0}</p>
                        </div>
                        <div className="rounded-xl border border-white/10 bg-black/25 p-2">
                          <p className="text-zinc-500">Earned</p>
                          <p className="text-base font-black text-green-400">{money(totals?.earned || 0)}</p>
                        </div>
                        <div className="rounded-xl border border-white/10 bg-black/25 p-2">
                          <p className="text-zinc-500">Paid</p>
                          <p className="text-base font-black text-blue-400">{money(totals?.paid || 0)}</p>
                        </div>
                        <div className="rounded-xl border border-white/10 bg-black/25 p-2">
                          <p className="text-zinc-500">Owed</p>
                          <p className="text-base font-black text-orange-400">{money(totals?.owed || 0)}</p>
                        </div>
                      </div>
                      <p className="mt-2 text-xs font-semibold text-zinc-500">
                        Borrowed this week: <span className="font-black text-purple-400">{money(totals?.borrowed || 0)}</span>
                      </p>
                    </div>
